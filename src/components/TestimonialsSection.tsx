    ...
    <section className="bg-background py-20 sm:py-32 relative border-t border-border overflow-hidden">
      <div className="container z-10 mx-auto px-5 sm:px-8 max-w-7xl">
        ...
        >
          ...
          <p className="text-center mt-6 text-base text-muted-foreground leading-relaxed">
            Discover why leaders and teams love working with us to scale their business operations and digital presence.
          </p>
        </motion.div>
